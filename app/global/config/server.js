...
let HTTP_SERVER = {
    ...
    BET_RECODE:{url:`/mobile-projects`,method:METHOD_POST,body:{bought_at_from:"",bought_at_to:"",issue:"",serial_number:"",lottery_id:"",way_id:"",username:"",user_id:"",page:1,pagesize:20}},
    BET_DETAIL:{url:"",formatUrl:`/mobile-projects/#id/view`,method:METHOD_POST,body:{page:1,pagesize:20}},
    //追号记录
    CHASE_RECODE:{url:`/mobile-traces`,method:METHOD_POST,body:{bought_at_from:"",bought_at_to:"",issue:"",serial_number:"",lottery_id:"",way_id:"",username:"",user_id:"",page:1,pagesize:20}},
    //追号详情
    ...
    // 修改登陆密码
    PWD_LOGIN:{url:`/mobile-users/password-management/0`, method:METHOD_POST,body:{old_password:"",password:"",password_confirmation:""}},
    // 修改资金密码
    PWD_FUND:{url:`/mobile-users/password-management/1`, method:METHOD_POST,body:{old_fund_password:"",fund_password:"",fund_password_confirmation:""}},
    //设置资金密码
    PWD_CONFIG_FUND:{url:`/mobile-users/safe-reset-fund-password`, method:METHOD_POST,body:{fund_password:"",fund_password_confirmation:""}},
    //mobile-bank-cards/银行卡列表
    LIST_BANGK_CARDS:{url:`/mobile-bank-cards`,method:METHOD_POST,body:{page:1,pagesize:15}},
    //删除bangkCard
    BANK_CARDS_DEL:{url:`/mobile-bank-cards/destroy`,method:METHOD_POST,body:{id:1,account_name:"",account:"",fund_password:""}},
    // step1验证旧银行卡信息:
    BANK_CARD_ADD_STEP_0:{url:`/mobile-bank-cards/0/bind-card`,method:METHOD_POST,body:{id:1,account_name:"",account:"",fund_password:""}},
    // step2获取增加银行的数据
    BANK_CARD_ADD_STEP_1:{url:`/mobile-bank-cards/1/bind-card`,method:METHOD_POST,body:{}},
    //step3提交确认银行卡信息
    BANK_CARD_ADD_STEP_2:{url:`/mobile-bank-cards/2/bind-card`,method:METHOD_POST,body:{bank_id:1,branch:0,province_id:0,city_id:0,account_name:"",account:"",account_confirmation:"",fund_password:""}},
    //添加银行卡 step1验证旧银行卡信息:
    BANK_CARD_MODIFY_STEP_O:{url:"",formatUrl:`/mobile-bank-cards/0/#id/modify-card`,method:METHOD_POST,body:{id:1,account_name:"",account:"",fund_password:""}},
    //step2获取增加银行的数据
    BANK_CARD_MODIFY_STEP_1:{url:"",formatUrl:`/mobile-bank-cards/1/#id/modify-card`,method:METHOD_POST,body:{}},
    //step3提交确认银行卡信息
    BANK_CARD_MODIFY_STEP_2:{url:"",formatUrl:`/mobile-bank-cards/2/#id/modify-card`,method:METHOD_POST,body:{bank_id:1,branch:0,province_id:0,city_id:0,account_name:"",account:"",account_confirmation:"",fund_password:""}},
    ...
    TRANSFER_SUB_MINT:{url:`/mobile-transfers/transfer-to-sub`,method:METHOD_POST,body:{card_number:"",card_id:"",fund_password:"",amount:0,username:""}},
    //提现
